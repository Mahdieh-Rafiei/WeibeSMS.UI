...
export class UserLinesComponent implements OnInit {
    ...
    tableConfig: TableConfigInterface = {
        ...
        headersConfig: [
            ...
            {hideInResponsive: false, title: 'Country'},
            {hideInResponsive: false, title: 'Number'},
            {hideInResponsive: false, title: 'Next billing date'},
            {hideInResponsive: false, title: 'Cost'},
            {hideInResponsive: false, title: 'Manage'},
        ]
    };
    ...
    generateRowColumns() {
        this.tableConfig.rowColumnsConfig.push({propertyName: 'countryName', hideInResponsive: false});
        this.tableConfig.rowColumnsConfig.push({propertyName: 'number', sign: '+', hideInResponsive: false});
        this.tableConfig.rowColumnsConfig.push({propertyName: 'expirationDateTime', hideInResponsive: false, isDateTime: true});
        this.tableConfig.rowColumnsConfig.push({propertyName: 'cost', sign: '€', hideInResponsive: false});
    }
}
